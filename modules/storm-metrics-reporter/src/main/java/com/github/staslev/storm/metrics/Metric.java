...
public class Metric {
	...
	public static class Option {
		...
		public static final Predicate<Optional<Metric>> isPresent = new Predicate<Optional<Metric>>() {
			@Override
		...
		public static final Function<Optional<Metric>, Metric> getValue = new Function<Optional<Metric>, Metric>() {
			@Override
	 ...
	 *
	 * @param after
	 *            the string literal to skip.
	 * @return the operation portion of the metric after a given string literal.
	 *         If the provided string literal is not present in the operation
	 *         string, the operation string is returned as is.
	 */
	public String getOperationAfterString(String after) {
		return !getOperation().contains(after) ? getOperation()
	 ...
	 *
	 * @param metricNameFragments
	 *            The metric metricNameFragments.
	 ...
	 *
	 * @param metricNameFragment
	 *            A metric name fragment string.
	 * @return A "clean" metric name fragment string, with restricted characters
	 *         replaced.
	 */
	public static String cleanNameFragment(final String metricNameFragment) {
		return metricNameFragment.replace("__", "").replace('/', '.').replace(':', '_');
	}
	...
	public String toString() {
		return "MetricName = " + this.getMetricName() +
