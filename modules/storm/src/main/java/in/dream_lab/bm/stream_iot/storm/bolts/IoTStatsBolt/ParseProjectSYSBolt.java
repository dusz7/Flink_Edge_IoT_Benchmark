...
public class ParseProjectSYSBolt extends BaseRichBolt {
	...
	public void execute(Tuple input) {
...

		{
			...
			sensorDetails = StringUtils.join(Arrays.copyOfRange(rowStringArray, 0, 4), ","); // TODO:
																								// ts
																								// to
																								// lat
			sensorID = rowStringArray[1];
			observedValArr = Arrays.copyOfRange(rowStringArray, 4, 9); // temp
																		// to aq
	...
	public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
		...
		outputFieldsDeclarer.declare(new Fields("sensorMeta", "sensorID", "obsType", "obsVal", "MSGID")); // obsType
																											// =
																											// {temp,
																											// humid,
																											// airq,
