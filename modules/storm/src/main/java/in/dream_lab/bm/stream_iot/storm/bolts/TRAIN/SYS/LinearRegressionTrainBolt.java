...
public class LinearRegressionTrainBolt extends BaseRichBolt {
	...
	public void execute(Tuple input) {
		...
		//
		// try {
		// LinearRegressionPredictor.lr = (LinearRegression)
		// SerializationHelper.read(blobModelObject);
		// } catch (Exception e) {
		// e.printStackTrace();
		// }
		...
		/*
		 * if(l.isInfoEnabled()) {
		 * l.info("Trained Model L.R. after bytestream object-{}",
		 * model.toString()); l.info("res linearRegressionPredictor-" + res); }
		 */
