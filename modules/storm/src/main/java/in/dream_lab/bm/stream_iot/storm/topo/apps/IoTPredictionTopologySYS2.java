...
import in.dream_lab.bm.stream_iot.storm.bolts.IoTPredictionBolts.SYS.MQTTPublishBolt;
import in.dream_lab.bm.stream_iot.storm.bolts.IoTPredictionBolts.SYS.SenMLParseBoltPREDSYS;
...
import in.dream_lab.bm.stream_iot.storm.spouts.SampleSenMLSpout2;
 ...
 */
public class IoTPredictionTopologySYS2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String spout1InputFilePath= resourceDir + "/SYS_sample_data_senml.csv";
         ...
         builder.setSpout("spout1", new SampleSenMLSpout2(spout1InputFilePath, spoutLogFileName, argumentClass.getScalingFactor(), inputRate, numEvents),
                1);
